...
@Component({
  selector: 'app-countryranking',
  templateUrl: './countryranking.page.html',
  styleUrls: ['./countryranking.page.scss'],
})
export class CountryrankingPage implements AfterViewInit {
